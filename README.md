...
```bash
./table_comparator --table-a-path ./data/tableA.csv --table-b-path ./data/tableB.csv --table-a-separator ',' --table-b-separator ',' --pk-column PESEL --result-path ./data/comparison_result
```
